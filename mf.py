# i pledge my honor tat i have abided by the stevens Honor System ~MF
...
def read_ged(directory="."):
    ...
    for file in listdir(directory):
        ...
        if file.split(".")[-1] == "ged":
            ...
            break
    ged = open("C://Users//Mitch//Documents//GitHub//ssw555project//Test files//test.ged", "r").read()
    return ged.split("\n")
    ...
    for i in range(0, len(gedlines)):
        ...
        if current[0] == "0":
            ...
            if current[0] == "1":
                ...
                if (not [current[0], current[1]] in check) or (not parent[1] in record_from_tag(current[1])[2]) or (
                        parent[1] != "INDI" and parent[1] != "FAM"):
                    continue
        ...
        for key in gedout["families"]:
            ...
            if "DIV" in entry:
                try:
                    ...
                    pass
            rows.append(
                [row_id, row_married, row_divorced, row_husband_id, row_husband_name, row_wife_id, row_wife_name,
                 row_children])
...
def print_married(gedout):
    ...
    for key in gedout["individuals"]:
        for i in range(couples.__len__()):
            # if person is a exists and they are dead
            if (couples[i][0] == key  and 'DEAT' in gedout["individuals"][key] ):
                del couples[i];


        for i in range(couples.__len__()):
            # if person is a exists and they are dead
            if (couples[i][1] == key and 'DEAT' in gedout["individuals"][key]):
                del couples[i];
...
if __name__ == "__main__":
    gedout = {'individuals': {
        'I01': {'NAME': 'Joe /Smith/', 'BIRT': '15 JUL 1960', 'SEX': 'M', 'FAMS': 'F23', 'DEAT': '31 DEC 2013'},
        'I07': {'NAME': 'Jennifer /Smith/', 'BIRT': '23 SEP 1960', 'SEX': 'F', 'FAMS': 'F23'},
        'I19': {'NAME': 'Dick /Smith/', 'BIRT': '13 FEB 1981', 'SEX': 'M', 'FAMC': 'F23'},
        'I26': {'NAME': 'Jane /Smith/', 'BIRT': '2 JUN 1983', 'SEX': 'F', 'FAMC': 'F23'}},
              'families': {'F23': {'MARR': '14 FEB 1980', 'HUSB': 'I01', 'WIFE': 'I07', 'CHIL': ['I19', 'I26']}}}
    assert(len(print_married(gedout)) == 0)
    gedout = {'individuals': {
        'I01': {'NAME': 'Joe /Smith/', 'BIRT': '15 JUL 1960', 'SEX': 'M', 'FAMS': 'F23'},
        'I07': {'NAME': 'Jennifer /Smith/', 'BIRT': '23 SEP 1960', 'SEX': 'F', 'FAMS': 'F23'},
        'I19': {'NAME': 'Dick /Smith/', 'BIRT': '13 FEB 1981', 'SEX': 'M', 'FAMC': 'F23'},
        'I26': {'NAME': 'Jane /Smith/', 'BIRT': '2 JUN 1983', 'SEX': 'F', 'FAMC': 'F23'}},
        'families': {'F23': {'MARR': '14 FEB 1980', 'HUSB': 'I01', 'WIFE': 'I07', 'CHIL': ['I19', 'I26']}}}

    assert (len(print_married(gedout)) == 1)
    #------------------------------------------------------

    gedout = {'individuals': {
        'I01': {'NAME': 'Joe /Smith/', 'BIRT': '15 JUL 2014', 'SEX': 'M', 'FAMS': 'F23', 'DEAT': '31 DEC 2013'},
        'I07': {'NAME': 'Jennifer /Smith/', 'BIRT': '23 SEP 1960', 'SEX': 'F', 'FAMS': 'F23'},
        'I19': {'NAME': 'Dick /Smith/', 'BIRT': '13 FEB 1981', 'SEX': 'M', 'FAMC': 'F23'},
        'I26': {'NAME': 'Jane /Smith/', 'BIRT': '2 JUN 1983', 'SEX': 'F', 'FAMC': 'F23'}},
        'families': {'F23': {'MARR': '14 FEB 1980', 'HUSB': 'I01', 'WIFE': 'I07', 'CHIL': ['I19', 'I26']}}}
    assert (len(birthBeforeDeath(gedout)) == 1)
    gedout = {'individuals': {
        'I01': {'NAME': 'Joe /Smith/', 'BIRT': '15 JUL 1960', 'SEX': 'M', 'FAMS': 'F23', 'DEAT': '31 DEC 2013'},
        'I07': {'NAME': 'Jennifer /Smith/', 'BIRT': '23 SEP 1960', 'SEX': 'F', 'FAMS': 'F23'},
        'I19': {'NAME': 'Dick /Smith/', 'BIRT': '13 FEB 1981', 'SEX': 'M', 'FAMC': 'F23'},
    ...
    assert (len(birthBeforeDeath(gedout)) == 0)

    gedout = {'individuals': {
        'I01': {'NAME': 'Joe /Smith/', 'BIRT': '15 JUL 1960', 'SEX': 'M', 'FAMS': 'F23', 'DEAT': '31 DEC 2013'},
        'I07': {'NAME': 'Jennifer /Smith/', 'BIRT': '23 SEP 1960', 'SEX': 'F', 'FAMS': 'F23', 'DEAT': '31 DEC 2013'},
        'I19': {'NAME': 'Dick /Smith/', 'BIRT': '13 FEB 1981', 'SEX': 'M', 'FAMC': 'F23'},
        'I26': {'NAME': 'Jane /Smith/', 'BIRT': '2 JUN 1983', 'SEX': 'F', 'FAMC': 'F23'}},
        'families': {'F23': {'MARR': '14 FEB 1980', 'HUSB': 'I01', 'WIFE': 'I07', 'CHIL': ['I19', 'I26']}}}
